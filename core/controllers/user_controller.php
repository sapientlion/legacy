...
class UserController extends SystemController
{
	...
	private function set(mixed $stmt) : array
	{
		...
		$_SESSION[SESSION_VAR_NAME_USER_CAN_READ_POSTS] = $result[DB_TABLE_USER_CAN_READ_POSTS];
		...
		$_SESSION[SESSION_VAR_NAME_USER_CAN_CREATE_COMMENTS] = $result[DB_TABLE_USER_CAN_CREATE_COMMENTS];
		$_SESSION[SESSION_VAR_NAME_USER_CAN_READ_COMMENTS] = $result[DB_TABLE_USER_CAN_READ_COMMENTS];
		$_SESSION[SESSION_VAR_NAME_USER_CAN_UPDATE_COMMENTS] = $result[DB_TABLE_USER_CAN_UPDATE_COMMENTS];
		$_SESSION[SESSION_VAR_NAME_USER_CAN_DELETE_COMMENTS] = $result[DB_TABLE_USER_CAN_DELETE_COMMENTS];
